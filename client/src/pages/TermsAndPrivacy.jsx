    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {activeTab === 'terms' && (
        <div className="space-y-4">
          ...
          <p>9. Termination: The agreement ends on the last day of the rental term. Spot Furnish may terminate for non-payment or breach of terms.</p>
          <p>10. Assignment: Customers cannot transfer the agreement without written consent.</p>
          <p>11. Indemnification: Customers indemnify Spot Furnish against claims except for negligence by Spot Furnish.</p>
          <p>12. Governing Law: Governed by Indian laws with exclusive jurisdiction in Kolkata.</p>
          <p>13. Limitation of Liability: Spot Furnish is not liable for indirect or consequential damages.</p>
      ...
      {activeTab === 'privacy' && (
        <div className="space-y-4">
          ...
          <p>Spot Furnish is committed to protecting your privacy. The following information is collected when you use our website: Name, Contact Information, Mobile Number, Address.</p>
