...
const ContactPage = () => {
  ...
  <div>
    ...
    <div data-aos="fade-right">
      ...
      {/* Grid layout for contact info cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">8th Main, Sonnappa Layout,</p>
            <p className="text-gray-600">Ramamurty Nagar Main Road,</p>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">+91 8123096298</p>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600">contact@spotfurnish.com</p>
            <p className="text-gray-600">spotfurnishrentals@gmail.com</p>
          </div>
        </div>
      ...
      <div className="mt-12">
        ...
        <div className="flex flex-wrap gap-4">
          <a href="https://www.facebook.com/spot.furnish/" target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-700 p-3 rounded-full text-white transition duration-300">
          ...
          <a href="#" className="bg-red-600 hover:bg-red-700 p-3 rounded-full text-white transition duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M21.543 6.498C22 8.28 22 12 12 12s0 3.72-.457 5.502c-.254.985-.997 1.76-1.938 2.022C17.896 20 12 20 12 20s-5.893 0-7.605-.476c-.945-.266-1.687-1.04-1.938-2.022C2 15.72 2 12 2 12s0-3.72.457-5.502c.254-.985.997-1.76 1.938-2.022C6.107 4 12 4 12 4s5.896 0 7.605.476c.945.266 1.687 1.04 1.938 2.022zM10 15.5l6-3.5-6-3.5v7z"></path>
            </svg>
          </a>
        </div>
      </div>
    ...
    {/* Contact Form is commented out in the original code */}
  </div>
</div>
